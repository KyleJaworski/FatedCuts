  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Get notified when I change my hours/services, and unsubscribe at any
        time.
      </p>
    ...
    <>
      <Container className="mt-9">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          {/* Left Section */}
          <div className="max-w-2xl border-purple-200">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
              Header goes here
            </h1>
            <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae
              in modi iure reprehenderit labore amet, officia eligendi aliquid
              accusantium porro hic veritatis consequatur consectetur quos minus
              repellendus tenetur, culpa accusamus.
            </p>
